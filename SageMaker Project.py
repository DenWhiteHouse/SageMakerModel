...
# **Answer:** removes HTML tags, convertsinto lower case, splits strings and remove stopwords
...
# **Answer:** 'movi','film', 'one', 'like' , 'time' || Well considering we are using movies and films reviews, yes they do make sense
...
# **Answer:** By doing this we make standardize the size on inputs and process only relevant words in word_dict
...
# **Answer:** I felt I had more control over this model, but I've to admit was way faster using the XGBoost and I've got a slightly better accuracy 
...
# **Answer:** (Hunger Games) - Label: POSITIVE - Model prediction: POSITIVE                                                  -------> 
# Excellent Movie this is an excellent movie and although Katniss is a positive role model, realize that only one is supposed to come out of the games alive. All the other's must die
